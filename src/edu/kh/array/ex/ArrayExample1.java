...
public class ArrayExample1 {
   ...
   /* 배열 (Array)
    * - 같은 자료형의 변수를 하나의 묶음으로 다르는 것.
    * - 묶여진 변수들은 하나의 배열명으로 불러지고
    *   구분은 index 를 이용함.(index는 0부터 시작하는 정수)
    * 
    **/
	...
	public void ex1() {
		...
		//배열 요소 값 대입
		// arr운 int[] 참조형 변수 이지만
		//arr[0]은 int자료형 변수이기 떄문에 정수값을 대입할 수 있다!
	 ...
	 public void ex2( ) {
		 ...
		 for(int i =0; i<arr.length; i++){
			 System.out.printf("arr[%d]에 저정된 값:%d\n", i , arr[i]);
	 ...
	 public void ex3() {
		...
		//height 에 heap 영역에 새로 생성된 double 5 칸짜리 double[]의 시작주소를 대입
